...
class ProjectKanban:
    ...
    def generate_overview_chart(self):
        ...
        fig.suptitle('PG-GMO项目开发进度看板', fontsize=20, fontweight='bold')
...
"""
    ...
    def generate_detailed_report(self) -> str:
        """生成详细的项目报告"""
        report_lines = []
        report_lines.append("# PG-GMO项目开发进度详细报告")
...
def main():
    ...
    parser = argparse.ArgumentParser(description='PG-GMO项目开发进度看板工具')
